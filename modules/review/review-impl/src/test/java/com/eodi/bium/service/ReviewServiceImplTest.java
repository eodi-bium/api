...
class ReviewServiceImplTest {
    ...
    void 리뷰제출_멤버검증_저장까지_한_컨텍스트에서() {
        ...
        org.assertj.core.api.Assertions.assertThat(saved.get(0).getMemberId()).isEqualTo(memberId);
        org.assertj.core.api.Assertions.assertThat(saved.get(0).getPlaceId()).isEqualTo(100L);
    }
