...
CREATE TABLE IF NOT EXISTS place_recycling_type (
...
INSERT INTO place_recycling_type (place_id, recycling_types) VALUES (1, 'BATTERY');
INSERT INTO place_recycling_type (place_id, recycling_types) VALUES (1, 'CLOTHES');

-- Case 2: [성공 예상] 학익동 주민센터 (약 1.5km 거리 - 3km 이내)
INSERT INTO place (place_name, address, latitude, longitude, phone_number)
VALUES ('학익동 수거함', '인천 미추홀구 학익동', 37.440000, 126.660000, '032-000-0002');

INSERT INTO place_recycling_type (place_id, recycling_types) VALUES (2, 'LIGHT');

-- Case 3: [실패 예상] 송도 센트럴파크 (약 6km 거리 - 3km 밖)
INSERT INTO place (place_name, address, latitude, longitude, phone_number)
VALUES ('송도 스마트 수거함', '인천 연수구 송도동', 37.393000, 126.640000, '032-000-0003');

INSERT INTO place_recycling_type (place_id, recycling_types) VALUES (3, 'PHONE');
INSERT INTO place_recycling_type (place_id, recycling_types) VALUES (3, 'BATTERY');